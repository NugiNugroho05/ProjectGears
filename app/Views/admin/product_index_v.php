...
<div class="d-flex justify-content-between mb-3">
    ...
    <a href="<?= base_url('admin/product/add') ?>" class="btn btn-primary">+ Tambah Barang</a>
</div>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="<?= base_url('admin/product/delete/'.$p['id']) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Hapus?')">Hapus</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </tbody>
