        ...
        <div class="container py-5">
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">Products</th> <th scope="col">Name</th>
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url('assets/img/product-1.jpg') ?>" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                </div>
                            </th>
                            <td>
                        ...
                        <tr>
                            <th scope="row">
                                <div class="d-flex align-items-center">
                                    <img src="<?= base_url('assets/img/product-2.jpg') ?>" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                </div>
                            </th>
                            <td>
                                <p class="mb-0 py-4">Apple iPad Mini</p>
