...
<head>
    ...
    <style>
        ...
        .logout-btn { color: #ff6b6b !important; font-weight: bold; margin-top: 20px; }
        .logout-btn:hover { background: #452a2a !important; color: #ff4444 !important; }
    </style>
</head>
<body>
<div class="container-fluid">
    <div class="row">
        <div class="col-md-2 p-0 sidebar shadow">
            ...
            <hr class="bg-light">
            <a href="<?= base_url('admin/logout') ?>" class="logout-btn" onclick="return confirm('Yakin ingin keluar dari sistem?')">
